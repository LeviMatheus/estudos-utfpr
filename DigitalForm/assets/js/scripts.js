...
jQuery(document).ready(function() {
    ...
    */
    ...
    $('.f1 .btn-next').on('click', function() {
        ...
        var spn = document.getElementById("f1-email");
        if(spn.classList.contains("ng-invalid-email")){
            next_step = false;
        }else{
            next_step = true;
        }
    ...
    $('.f1').on('submit', function(e) {
    	...
    	// fields validation
    	$(this).find('input[type="text"], input[type="password"], input[type="password"], textarea').each(function() {
    		if( $(this).val() == "" ) {
    			e.preventDefault();
    			$(this).addClass('input-error');
    		}
