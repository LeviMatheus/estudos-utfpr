/* Generated By:JJTree&JavaCC: Do not edit this line. MALanguageTokenManager.java */
package parser;
import recovery.*;

/** Token Manager. */
public class MALanguageTokenManager implements MALanguageConstants
{
...
static private int jjMoveStringLiteralDfa0_0()
{
   switch(curChar)
   {
      ...
      case 61:
         return jjStartNfaWithStates_0(0, 17, 53);
      case 97:
...
static private int jjMoveStringLiteralDfa1_0(long active0)
{
   ...
   switch(curChar)
   {
      ...
      case 101:
         return jjMoveStringLiteralDfa2_0(active0, 0x100004800L);
      case 108:
...
static private int jjMoveStringLiteralDfa2_0(long old0, long active0)
{
   ...
   {
      case 97:
         return jjMoveStringLiteralDfa3_0(active0, 0x220000080L);
      case 100:
      ...
      case 117:
         return jjMoveStringLiteralDfa3_0(active0, 0x203400L);
      default :
         break;
   }
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               case 7:
                  ...
                  else if ((0x5000004000000000L & l) != 0L)
                  {
                     if (kind > 25)
                        kind = 25;
                  }
...
static final int[] jjnextStates = {
   202, 209, 161, 174, 191, 141, 154, 155, 105, 123, 79, 92, 
};

/** Token literal values. */
public static final String[] jjstrLiteralImages = {
"", null, null, null, null, null, null, "\163\155\141\141\141\163\150", null, 
"\171\141\156\144\145\162\145", "\153\165\165\144\145\162\145", "\144\145\162\145\144\145\162\145", 
"\164\163\165\156\164\163\165\156", "\164\163\165\156\144\145\162\145", "\144\145\163\165", null, null, "\75", 
"\54", null, "\155\157\145\155\157\145", "\153\171\165\156", "\50", "\51", "\56", 
null, null, "\163\164\145\151\156\163", null, "\141\171\141\171\141", "\47", 
"\171\141\155\145\162\157", "\162\145\144\157\156\144\141", "\160\154\141\156\141", };
...
static private final int[] jjrounds = new int[210];
static private final int[] jjstateSet = new int[420];
static protected char curChar;
/** Constructor. */
public MALanguageTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public MALanguageTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
